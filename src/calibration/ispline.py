...
def fit_cdf(x, y, x_predict=None, num_basis=10, fit_intercept=False):
    ...
    fit_intercept : bool
        Kept for backwards compatibility; leave False. Fitting an intercept
        breaks both ends of the map -- it is estimated freely and never added
        back by ``get_pdf``, giving maps that span e.g. [-0.10, 1.08] instead
        of [0, 1].
